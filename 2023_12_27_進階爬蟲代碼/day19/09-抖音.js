...
document = {
    addEventListener: function (arg) {
        console.log('document的addEventListener对象获取的参数是', arg)
...
console.log(window.aaa("device_platform=webapp&aid=6383&channel=channel_pc_web&aweme_id=7336598535728598291&cursor=100&count=20&item_type=0&insert_ids=&whale_cut_token=&cut_version=1&rcFT=&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Edge&browser_version=121.0.0.0&browser_online=true&engine_name=Blink&engine_version=121.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=100&webid=7265944013042566675&msToken=JfdPGWDZSf0MP-flbsJQSDHgm2Qq5YCeTgflz3y125-u3ljDN4RIqfEhIM6-AliGSoK3Doqok-gFDUCpTwlOdsKsgAwJa9nbQX060e4X6yVSd5psCY3XZs0wOns=", null))
